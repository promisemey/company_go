      ...
      <view slot="back" class='tn-custom-nav-bar__back'
		...
		<view class="about__wrap">
			...
			<view class="user-info__container tn-flex tn-flex-direction-column tn-flex-col-center tn-flex-row-center">
				<view class="user-info__avatar tn-bg-grey--light tn-flex tn-flex-col-center tn-flex-row-center">
					<view class="tn-shadow-blur"
						style="background-image:url('https://resource.tuniaokj.com/images/blogger/avatar_2.jpeg');width: 170rpx;height: 170rpx;background-size: cover;">
					</view>
					<!-- <view class="tn-icon-logo-tuniao" style="font-size: 140rpx;color: #01BEFF;"></view> -->
				</view>
				<view class="user-info__nick-name">{{userInfo ? userInfo.username :'尚未登录'}}</view>
			</view>
			...
			<view class="about-shadow tn-margin-top-xl tn-padding-top-sm tn-padding-bottom-sm tn-margin-left tn-margin-right">
				...
				<tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="30" @click="complete">
					<view class="tn-flex tn-flex-col-center">
						<view
			...
			<!-- 退出 -->
			<view class="padding">
				<button class="cu-btn block">退出登录</button>
			</view>
			<!-- 退出 -->
...
<script>
	...
	export default {
		...
		methods: {
			complete() {
				const url = this.userInfo ? '/pages/setting/setting' : '/pages/login/login'
