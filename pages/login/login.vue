...
<script>
	...
	export default {
		...
		methods: {
			...mapActions({
				USERLOGIN: 'user/userLoginAction'
			}),
			// 登录
			handleLogin() {
...
<style lang="scss" scoped>
	...
	/* 粒子背景 start*/
	.template-login2 {
		background: linear-gradient(90deg, #ff9068, #ff8263);
		min-height: 100vh;
		display: flex;
	...
	/deep/.tn-cool-bg-color-7--reverse {
		// background-color: transparent;
		background-image: repeating-linear-gradient(-90deg, #ff9068, #ff8263)
	}

	/deep/.tn-cool-bg-color-15--reverse {
		// background-color: transparent;
		background-image: repeating-linear-gradient(-90deg, #ff9068, #ff8263)
	}
</style>